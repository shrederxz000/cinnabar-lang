...
private:
    ...
    static void serialize_identifier_expr(std::ostringstream& out, const IdentifierExpr* node, int indent);
    static void serialize_literal_expr(std::ostringstream& out, const LiteralExpr* node, int indent);
